...
PlotSpectroTemporal(sound_signal, time_limits = [1.2, 1.5], figure_size=(750, 400))
```
...
sound = sound .* 0.03
PlotSpectroTemporal(sound, frequency_limits = [0, 3000], time_limits = [0.135, 0.33], amplitude_limits = [-0.6, 0.6], figure_size=(750, 400))
```
